...
Version tags such as `v3.2.2` also trigger a GitHub Actions release build that
...
```bash
uv tool install \
  "https://github.com/ibitato/MistralClient/releases/download/v3.2.2/mistralcli-3.2.2-py3-none-any.whl"
```
